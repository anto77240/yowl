			...
			<div class="controls">
				...
				<div class="signup">
					<form @submit.prevent="createAccount">
						...
						<label> E-mail </label>
						<input class="input is-primary is-rounded" type="email" v-model="email" required />
						...
						<input class="input is-primary is-rounded" type="date" v-model="birthday" required />

						<label> Profile picture </label>
						<input class="input is-primary is-rounded" type="test" v-model="avatar" required />

						<label> Gender </label>
						<div class="inputRadio">
							<div>
								<input type="radio" id="Male" value="M" name="gender" v-model="gender" />
								<label class="radio" for="Male">Male</label>
							</div>
							<div>
								<input type="radio" id="Female" value="F" name="gender" v-model="gender" />
